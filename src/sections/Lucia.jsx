    ...
    <section className='lucia-life'>
      ...
      <div className='lg:w-1/2 lucia-life-content'>
        <div className='max-w-xl lg:ps-32 ps-10'>
          <h1>Lucia Caminos</h1>
          <h1>Lucia's father taught her to fight as soon as she could walk</h1>
          <h2>A life with Jason could be her way out.</h2>
          <p>
            Life has been coming at her swinging ever since. Fighting for her family landed 
            her in the Leonida Penitentiary. Sheer luck got her out. Lucia's learned her lesson
            -only smart moves from here
          </p>
        </div>
